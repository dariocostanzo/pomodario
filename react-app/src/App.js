...
function App() {
  ...
  const theme = createTheme({
    palette: {
      ...
      primary: {
        main: timerMode === 'pomodoro' ? '#DB524D' : 
              timerMode === 'shortBreak' ? '#4C9195' : '#457CA3',
      },
      background: {
        default: darkMode ? '#121212' : 
                 timerMode === 'pomodoro' ? '#FFF5F5' : 
                 timerMode === 'shortBreak' ? '#F0F9FA' : '#F0F5FA',
  ...
  }, [isActive, isPaused, timeLeft, timerMode, settings, pomodoroCount, stats]);
